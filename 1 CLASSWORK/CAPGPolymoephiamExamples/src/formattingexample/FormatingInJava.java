...
//import java.util.Calendar;
//
public class FormatingInJava {
//
//	public static void main(String[] args) 
//	{
//		// TODO Auto-generated method stub
//		String str="to play cricket";
//		String hobby=String.format("My fav hobby is %s", str);
//		System.out.println(hobby);
//		
//		float mySalary=2345.67f;
//		System.out.println(String.format("My salary = %.8f", mySalary));
//		System.out.println(String.format("My salary = %16.8f", mySalary));
//		
//		int val=12345;
//		System.out.println(String.format("%07d", mySalary));
//		
//		System.out.format("local time ", Calendar.getInstance());
//		
//	}
//
